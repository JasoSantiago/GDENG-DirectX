...
Cylinder::Cylinder(std::string name, float height, float radius, int sectorCount, bool hasPhysics, Vector3D pos, Vector3D scale, Vector3D rot) : AGameObject(name, AGameObject::PrimitiveType::CYLINDER)
{
